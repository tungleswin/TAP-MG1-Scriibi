...
class StudentSearchBox extends StatefulWidget {
  const StudentSearchBox({super.key});

  @override
  State<StudentSearchBox> createState() => _SearchBoxState();
}

class _SearchBoxState extends State<StudentSearchBox> {
  // Variables
  String _searchText = '';
